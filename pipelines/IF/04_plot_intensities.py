...
def run_full_analysis():
    ...
    for eid in df['image_id'].unique():
        ...
        sns.regplot(data=sub, x='center_y', y='GATA3_dapi_norm', ax=ax4,
                    scatter_kws={'alpha': 0.2, 'color': 'cyan'}, line_kws={'color': 'red'})
        ax4.set_title("GATA3 vs Y-Position"); ax4.set_xlabel("Y-coordinate (Top=0)")

        sns.regplot(data=sub, x='center_y', y='CDX2_dapi_norm', ax=ax5,
                    scatter_kws={'alpha': 0.2, 'color': 'magenta'}, line_kws={'color': 'red'})
